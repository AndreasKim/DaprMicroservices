    ...
    public partial class Initial2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesInfos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rating = table.Column<double>(type: "float", maxLength: 1, nullable: false),
                    NumberOfSales = table.Column<int>(type: "int", nullable: false),
                    ...
                    CorporateEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AGB = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Shipment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Revocation = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentDetailsId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_PaymentDetails_PaymentDetailsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_SalesInfos_SalesInfoId",
                        column: x => x.SalesInfoId,
                        principalTable: "SalesInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_SalesInfos_SalesInfoId",
                        column: x => x.SalesInfoId,
                        principalTable: "SalesInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Conversations_Products_ProductId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_ProductId1",
                table: "Conversations",
                column: "ProductId1");
